...
class FaceHighlighterWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        default_color_row.addWidget(QLabel("颜色:"))
        ...
        default_color_row.addWidget(self.btn_default_model_color)
        default_color_row.addStretch()
        add_left(default_color_row)
        default_opacity_row = QHBoxLayout()
        default_opacity_row.addWidget(QLabel("透明:"))
        ...
        self.slider_default_model_opacity.setMinimumWidth(120)
        default_opacity_row.addWidget(self.slider_default_model_opacity, stretch=1)
        default_opacity_row.addSpacing(12)
        self.lbl_default_model_opacity = QLabel("1.00")
        default_opacity_row.addWidget(self.lbl_default_model_opacity)
        add_left(default_opacity_row)
        ...
        iso_color_row = QHBoxLayout()
        iso_color_row.addWidget(QLabel("颜色:"))
        ...
        iso_color_row.addWidget(self.btn_isosurface_color)
        iso_color_row.addStretch()
        add_right(iso_color_row)
        iso_opacity_row = QHBoxLayout()
        iso_opacity_row.addWidget(QLabel("透明:"))
        ...
        self.slider_isosurface_opacity.setMinimumWidth(120)
        iso_opacity_row.addWidget(self.slider_isosurface_opacity, stretch=1)
        iso_opacity_row.addSpacing(12)
        self.lbl_isosurface_opacity = QLabel("1.00")
        iso_opacity_row.addWidget(self.lbl_isosurface_opacity)
        add_right(iso_opacity_row)
        ...
        # B-spline 延展：extV 滑条一行，延展按钮一行
        iso_ext_slider_row = QHBoxLayout()
        iso_ext_slider_row.addWidget(QLabel("extV:"))
        ...
        self.slider_isosurface_ext_v.setMinimumWidth(120)
        iso_ext_slider_row.addWidget(self.slider_isosurface_ext_v, stretch=1)
        iso_ext_slider_row.addSpacing(12)
        self.lbl_isosurface_ext_v = QLabel("0.00")
        iso_ext_slider_row.addWidget(self.lbl_isosurface_ext_v)
        add_right(iso_ext_slider_row)
        iso_ext_btn_row = QHBoxLayout()
        ...
        iso_ext_btn_row.addWidget(self.btn_isosurface_extend)
        iso_ext_btn_row.addStretch()
        add_right(iso_ext_btn_row)
